...
public class Service {
    ...
    /**
     * validateAdmin
     * Validates admin username/password, returns token if OK.
     */
    ...
    /**
     * filterDoctor
     * Supports flexible combinations of name/specialty/time.
    ...
    public Map<String, Object> filterDoctor(String name, String specialty, String time) {
        ...
        // Coursera frontend often passes literal "null"
    ...
    /**
     * validateAppointment
     * @return 1 if valid, 0 if unavailable/invalid, -1 if doctor not found
     */
    public int validateAppointment(Appointment appointment) {
        ...
        String apptSlotStart = appointment.getAppointmentTime().toLocalTime().toString();

        // Template logic: compare against slot start times.
        return availableSlots.contains(apptSlotStart) ? 1 : 0;
    }

    /**
     * validatePatient
     * true if patient is eligible to create (no duplicate email/phone), false if already exists
     */
     ...
     * Validates patient login via email/password, returns token if OK.
     */
    ...
    /**
     * filterPatient
     * Filters appointments based on condition/doctor name for the patient identified by token.
     */
    public ResponseEntity<Map<String, Object>> filterPatient(String condition, String name, String token) {
        try {
            String identifier = tokenService.getEmailFromToken(token); // subject (email for patient)
